			...
			<div id="medicll-twocolumns" class="medicll-twocolumns">
				...
				<div class="<?php echo ($has_sidebar ? 'col-md-9 col-sm-8' . $content_class : 'col-md-12 col-sm-12') ?> col-xs-12">
					...
					while (have_posts()) :
						...
						the_post_navigation(
							array(
								'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'medicll') . '</span> <span class="nav-title">%title</span>',
								'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'medicll') . '</span> <span class="nav-title">%title</span>',
							)
						);
